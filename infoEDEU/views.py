...
def inicio(request):
    ...
    graficoLineaDisc1 = go.Figure()
    graficoLineaDisc2 = go.Figure()
    graficoLineaDisc3 = go.Figure()
    graficoLineaDisc4 = go.Figure()
    ...
    #-------grafico barras  tipoDiscapacidad
    # Añadir barras para la discapacidad fisica
    graficoLineaDisc1.add_trace(go.Bar(
        x=universidades,
        y=fisica,
        name='Fisica'
    ))

    graficoLineaDisc1.update_layout(
         width=540, 
        height=500, 
    title="Cantidad de Estudiantes por Discapacidad Fisica",
    xaxis_title="Universidades",
    yaxis_title="Tipo de Discapacidad")

    # Añadir barras para la discapacidad intelectual
    graficoLineaDisc2.add_trace(go.Bar(
        x=universidades,
        y=intelectual,
        name='Intelectual'
    ))

    graficoLineaDisc2.update_traces(marker=dict(color='purple'))


    graficoLineaDisc2.update_layout(
         width=540, 
        height=500, 
    title="Cantidad de Estudiantes por Discapacidad Intelectual",
    xaxis_title="Universidades",
    yaxis_title="Tipo de Discapacidad")
    

    # Añadir barras para la discapacidad sensorial
    graficoLineaDisc3.add_trace(go.Bar(
        x=universidades,
        y=sensorial,
        name='Sensorial'
    ))

    graficoLineaDisc3.update_traces(marker=dict(color='red'))

    graficoLineaDisc3.update_layout(
         width=540, 
        height=500, 
    title="Cantidad de Estudiantes por Discapacidad Sensorial",
    xaxis_title="Universidades",
    yaxis_title="Tipo de Discapacidad")

    # Añadir barras para la discapacidad mental
    graficoLineaDisc4.add_trace(go.Bar(
        x=universidades,
        y=mental,
        name='Mental'
    ))

    graficoLineaDisc4.update_traces(marker=dict(color='green'))

    graficoLineaDisc4.update_layout(
         width=540, 
        height=500, 
    title="Cantidad de Estudiantes por Discapacidad Mental",
    xaxis_title="Universidades",
    yaxis_title="Tipo de Discapacidad")
    ...
    graph_3 = graficoLineaDisc1.to_html(full_html=False)
    graph_4 = graficoLineaDisc2.to_html(full_html=False)
    graph_5 = graficoLineaDisc3.to_html(full_html=False)
    graph_6 = graficoLineaDisc4.to_html(full_html=False)
...
#no se usan, pero para futuros cambios quedan listas
#def inicio(request):
    estudiantes=Estudiante.objects.all()
