...
def inicio(request):
    ...
    graficoLineaDisc1.update_layout(
         width=540, 
        height=500, 
        title="Cantidad de Estudiantes por Discapacidad Física",
        xaxis_title="Universidades",
    ...
    graficoLineaDisc2.update_traces(marker=dict(color='green'))
    ...
    graficoLineaDisc4.update_traces(marker=dict(color='purple'))
